...
**Last updated:** 2026-08-09 (**T7 DONE.** The nightly job now prices the shelf:
`refresh_graded_prices` walks owned slabs stalest-first within a 50-lookup budget,
and the Market button no longer skips graded stock. T0/T1/T3/T4/T6 also DONE; T2
and T5 remain DEFERRED behind PSA account approval and block nothing. **T8 is the
next task** — and it inherits three doc corrections, see its Notes cell)
